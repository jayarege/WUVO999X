...
import { useMediaType } from '../../Navigation/TabNavigator'; // Adjust path as needed
import { getHomeStyles } from '../../Styles/homeStyles';
import { getHeaderStyles } from '../../Styles/headerStyles';
import { getModalStyles } from '../../Styles/modalStyles';
import { getButtonStyles } from '../../Styles/buttonStyles';
import { getRatingStyles } from '../../Styles/ratingStyles'; 
import { getLayoutStyles } from '../../Styles/layoutStyles'; // ✅ Added
...
function HomeScreen({ seen, unseen, genres, newReleases, isDarkMode, toggleTheme, onAddToSeen, onAddToUnseen }) {
  ...
  const layoutStyles = getLayoutStyles(mediaType, isDarkMode ? 'dark' : 'light', theme); // ✅ Fixed
