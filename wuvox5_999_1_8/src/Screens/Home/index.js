...
const fetchPopularMovies = useCallback(async () => {
 ...
 const renderAIRecommendationsSection = useCallback(() => {
    return (
      <View style={homeStyles.section}>
        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 1, marginTop: -1 }}>
          <Ionicons 
            name="sparkles" 
            size={16} 
            ...
            >
              ...
              >
                ...
                <Image
                  ...
                  resizeMode="cover"
                />
                <View style={[homeStyles.movieInfoBox, { height: 80, width: MOVIE_CARD_WIDTH - 6, padding: 4 }]}>
                  <Text
                    style={[homeStyles.genreName, { fontSize: 12, lineHeight: 14, marginBottom: 2 }]}
                    numberOfLines={2}
                    ellipsizeMode="tail"
