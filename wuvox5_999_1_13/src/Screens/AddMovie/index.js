...
function AddMovieScreen({ seen, unseen, onAddToSeen, onAddToUnseen, onRemoveFromWatchlist, onUpdateRating, genres, isDarkMode }) {
 ...
 return (
   <View style={{ flex: 1, backgroundColor: '#1C2526' }}>
     ...
     <View style={{ flex: 1, backgroundColor: '#1C2526', paddingTop: 0 }}>
     ...
     {/* Suggestions positioned below search bar */}
     ...
     <RatingModal
       ...
       movie={selectedMovie}
       ratingInput={selectedRating.toString()}
       setRatingInput={setSelectedRating}
       slideAnim={new Animated.Value(0)} // Add this line for animation
       mediaType={mediaType}
...
topRatedModalMovieDetails: {
  flex: 1,
},
topRatedModalMovieTitle: {
  fontSize: 24,
  fontWeight: 'bold',
  marginBottom: 4,
},
...
topRatedGenreTextContainer: {
  marginVertical: 8,
},
topRatedRatingDisplay: {
  flexDirection: 'row',
  alignItems: 'center',
  marginTop: 8,
},
